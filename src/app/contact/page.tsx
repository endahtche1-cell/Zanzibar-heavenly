        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn delay={0.3}>
            <div className="mt-10 border-t border-border pt-10">
              <p className="text-center text-xs font-medium uppercase tracking-[0.15em] text-teal">Bank Transfer</p>
              <div className="mx-auto mt-6 max-w-sm rounded-2xl border border-border bg-white px-8 py-7 shadow-sm">
