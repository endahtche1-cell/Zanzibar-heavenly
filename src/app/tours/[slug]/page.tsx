                  ...
                  <div className="border border-border bg-sand/50 p-6">
                    ...
                    <dl className="mt-4 space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium text-ink">{tour.groupSize}</dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-muted">Best Time</dt>
                        <dd className="font-medium text-ink">{tour.bestTimeToGo}</dd>
                      </div>
                    </dl>
                    {tour.pickupInfo && (
                      <p className="mt-4 border-t border-border pt-4 text-xs text-muted">{tour.pickupInfo}</p>
                    )}
                    <p className="mt-2 text-xs text-muted">{tour.cancellationPolicyShort}</p>
                  </div>
                </FadeIn>
              </div>
            </aside>
