...
export const metadata: Metadata = {
  ...
  description:
    'Browse photos from real Zanzibar Heavenly adventures — dhow cruises, spice tours, snorkelling, wildlife encounters, and more. See the island through our guests\' eyes.',
}
