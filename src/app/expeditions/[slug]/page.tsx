                  ...
                  <div className="rounded-xl border border-border bg-white p-6 shadow-sm">
                    ...
                    <dl className="mt-4 divide-y divide-border text-sm">
                      <div className="flex items-baseline justify-between py-3">
                        ...
                        <dd className="ml-4 text-right font-medium text-ink">{exp.duration}</dd>
                      </div>
                      <div className="flex items-baseline justify-between py-3">
                        <dt className="shrink-0 text-muted">Difficulty</dt>
                        <dd className="ml-4 text-right font-medium text-ink">{exp.difficulty}</dd>
                      </div>
                      <div className="flex items-baseline justify-between py-3">
                        <dt className="shrink-0 text-muted">Group Size</dt>
                        <dd className="ml-4 text-right font-medium text-ink">{exp.groupSize}</dd>
                      </div>
                      <div className="flex items-baseline justify-between py-3">
                        <dt className="shrink-0 text-muted">Best Time</dt>
                        <dd className="ml-4 text-right font-medium text-ink">{exp.bestTimeToGo}</dd>
                      </div>
                    </dl>
                    {exp.pickupInfo && <p className="mt-4 border-t border-border pt-4 text-xs leading-relaxed text-muted">{exp.pickupInfo}</p>}
                    <p className="mt-2 text-xs leading-relaxed text-muted">{exp.cancellationPolicyShort}</p>
                  </div>
                </FadeIn>
              </div>
            </aside>
