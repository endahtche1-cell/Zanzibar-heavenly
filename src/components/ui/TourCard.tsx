...
interface TourCardProps {
  item: Tour | Expedition
  type: 'tours' | 'expeditions'
}

export default function TourCard({ item, type }: TourCardProps) {
    ...
    <article className="group">
      <Link href={href} className="block">
        ...
        <div className="mt-4 px-1">
          ...
          {/* Accent bar */}
          <div className="mt-3 h-[2px] w-8 rounded-full bg-coral transition-all duration-300 group-hover:w-12" />
        </div>
      </Link>
    </article>
  )
